...
const requiredFieldsParagraph = document.getElementById(
...
function removeExistingFeedback(): void {
  const feedbackMessages =
    document.querySelectorAll<HTMLElement>(".copy-feedback");
    ...
    .then(() => {
      ...
      window.setTimeout(
        () => {
          ...
          latestPasswordElement.textContent =
            "Contraseña borrada por seguridad.";

          removeExistingFeedback();
          const clearMessage = document.createElement("span");
          clearMessage.textContent =
            "La contraseña ha sido borrada automáticamente.";
